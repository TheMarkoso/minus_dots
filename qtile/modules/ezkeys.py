...
from modules.prefs import terminal, browser, file_manager, screenshot, screenshot_manual, rofi, lockscreen, redshift_on, redshift_off, volume_up, volume_down, volume_mute
